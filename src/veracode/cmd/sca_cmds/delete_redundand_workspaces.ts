...
exports.command = 'delete_redundant_workspaces [inputfile]'
exports.desc = 'delete a list of workspaces with no projects based on a list in a file. List format can be generated by running the list_workspaces command';
